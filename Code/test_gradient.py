...
# we test that the manual gradients coincide with the gradients from autograd
# we check that for L2, L1 and no regularization parameter
...
def test_gradients_equal():
    ...
    # construct the network
        ffnn = NeuralNetwork(
                ...
                activation_derivatives, cost_fnc, cost_der, lmd =0.1, regularization=regularization_method
                )
